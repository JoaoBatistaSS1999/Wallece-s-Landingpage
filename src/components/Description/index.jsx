  ...
  return (
    <div id="features">
      <div class="bg-lightblue py-20 px-4">
        <div class="mx-auto max-w-6xl flex gap-10 flex-col md:flex-row">
          <dl class="w-full md:w-2/3 text-end">
            <dt class="mb-4 text-end">
          ...
          <div className="bg-yellow-300 rounded-xl h-[500px] md:w-1/3"></div>
        </div>
      </div>
    </div>
  );
